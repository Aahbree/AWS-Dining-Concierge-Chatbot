...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: 'AKIAQXCNDHWYIJQ5MYTZ',
            secretKey: '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',
            sessionToken: '',
            region: 'us-east-1',
            apiKey: undefined,
    ...
    var invokeUrl = 'https://so2r67fda1.execute-api.us-east-1.amazonaws.com/dev';
